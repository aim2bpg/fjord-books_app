...
ActiveRecord::Schema.define(version: 2021_10_25_043241) do
  ...
  create_table "followings", force: :cascade do |t|
    ...
    t.index ["follower_user_id", "followed_user_id"], name: "index_followings_on_follower_user_id_and_followed_user_id", unique: true
